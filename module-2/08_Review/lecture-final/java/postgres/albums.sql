...
drop table if exists AppUser,SaleAlbum,Sale,AlbumGenre,Track,Customer,Artist,RecordLabel,Album,Genre,MenuType,Menu,SecurityRole,MenuTypeMenu,MenuSecurityRole;
...
(
	...
	UserPasswordSalt		varchar(256),
	PasswordAlgorithm		varchar(20) not null,
	LastPasswordChange		timestamp,
	IsForcePasswordChange	        boolean not null,
	IsForceUserChange		boolean not null,
	CreateDate			timestamp,
	LanguageCode			varchar(20),
	DenyAccess			boolean not null,
	LastSuccessfulLoginDate		timestamp,
	LastFailedLoginAttemptnDate     timestamp,
	PreviousSuccessfulLoginnDate    timestamp,
...
insert into AppUser (
    ...
    (
        'rob'
        ,'admin'
        ,'YmJH+WL8utqsvx2q6aBHZg=='  --chicken
        ,'5ySh1gZQdL25Zl9CYjLWTt32UC4eBV06IKAE58xW2s29DzlhLdXOTGG3q189PCWjBMzAkTSJ+bfzF/3zwAlmUYFRcHtmzLDwallFRWTUQHJVxszLkLx6u+Ph2eVEwEaLPxOegvOehnx63hjl0qGTm3OA/M4Wwo9o0J2JPIuxCkY='
        ,'10001'
        ,false
        ,false
        ,current_timestamp
...
insert into MenuType (menutypecode) values ('main');
insert into MenuType (menutypecode) values ('genre');
insert into MenuType (menutypecode) values ('user');

insert into menu (menutext, MenuItemCode) values ('List all albums','ListAllAlbums');
insert into menu (menutext, MenuItemCode) values ('List all genres','ListAllGenres');
insert into menu (menutext, MenuItemCode) values ('Pick albums','PickAlbums');
insert into menu (menutext, MenuItemCode) values ('Pick albums by Genre','PickAlbumsGnre');
insert into menu (menutext, MenuItemCode) values ('Display picked Albums','ListPickedAlbums');
insert into menu (menutext, MenuItemCode) values ('Exit','Exit');

insert into menu (menutext, MenuItemCode) values ('Add Genre','AddGenre');
insert into menu (menutext, MenuItemCode) values ('Update Genre','UpdateGenre');
insert into menu (menutext, MenuItemCode) values ('Pick Genre','PickGenre');
insert into menu (menutext, MenuItemCode) values ('Delete Genre','DeleteGenre');

insert into menu (menutext, MenuItemCode) values ('Add User','AddUser');
insert into menu (menutext, MenuItemCode) values ('Change Password','ChangePassword');
insert into menu (menutext, MenuItemCode) values ('Delete User','DeleteUser');
insert into menu (menutext, MenuItemCode) values ('List Users','ListAllUsers');


insert into menu (menutext, MenuItemCode,SubMenuTypeId) values ('Manage Genres',null, (select MenuTypeId from MenuType where MenuTypeCode='genre'));
insert into menu (menutext, MenuItemCode,SubMenuTypeId) values ('User Management',null, (select MenuTypeId from MenuType where MenuTypeCode='user'));

insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='ListAllAlbums'),(select MenuTypeId from MenuType where MenuTypeCode='main'),1);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='ListAllGenres'),(select MenuTypeId from MenuType where MenuTypeCode='main'),2);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='PickAlbums'),(select MenuTypeId from MenuType where MenuTypeCode='main'),3);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='PickAlbumsGnre'),(select MenuTypeId from MenuType where MenuTypeCode='main'),4);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='ListPickedAlbums'),(select MenuTypeId from MenuType where MenuTypeCode='main'),5);

insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuText='Manage Genres'),(select MenuTypeId from MenuType where MenuTypeCode='main'),6);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuText='User Management'),(select MenuTypeId from MenuType where MenuTypeCode='main'),7);

insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='Exit'),(select MenuTypeId from MenuType where MenuTypeCode='main'),8);


insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='AddGenre'),(select MenuTypeId from MenuType where MenuTypeCode='genre'),1);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='UpdateGenre'),(select MenuTypeId from MenuType where MenuTypeCode='genre'),2);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='PickGenre'),(select MenuTypeId from MenuType where MenuTypeCode='genre'),3);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='DeleteGenre'),(select MenuTypeId from MenuType where MenuTypeCode='genre'),4);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='ListAllGenres'),(select MenuTypeId from MenuType where MenuTypeCode='genre'),5);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='Exit'),(select MenuTypeId from MenuType where MenuTypeCode='genre'),6);

insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='AddUser'),(select MenuTypeId from MenuType where MenuTypeCode='user'),1);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='ChangePassword'),(select MenuTypeId from MenuType where MenuTypeCode='user'),2);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='DeleteUser'),(select MenuTypeId from MenuType where MenuTypeCode='user'),3);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='ListAllUsers'),(select MenuTypeId from MenuType where MenuTypeCode='user'),4);
insert into MenuTypeMenu (MenuId, MenuTypeId, MenuOrder) values ((select MenuId from Menu where MenuItemCode='Exit'),(select MenuTypeId from MenuType where MenuTypeCode='user'),5);


insert into securityrole (code) values ('standard');
insert into securityrole (code) values ('manager');
insert into securityrole (code) values ('admin');

insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListAllAlbums'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListAllGenres'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='PickAlbums'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='PickAlbumsGnre'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListPickedAlbums'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='AddGenre'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='UpdateGenre'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='PickGenre'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='DeleteGenre'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='AddUser'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ChangePassword'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='DeleteUser'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListAllUsers'),(select SecurityRoleId from SecurityRole where Code='admin'));


insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListAllAlbums'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListAllGenres'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='PickAlbums'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='PickAlbumsGnre'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListPickedAlbums'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='AddGenre'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='UpdateGenre'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='PickGenre'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='DeleteGenre'),(select SecurityRoleId from SecurityRole where Code='manager'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ChangePassword'),(select SecurityRoleId from SecurityRole where Code='manager'));

insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListAllAlbums'),(select SecurityRoleId from SecurityRole where Code='standard'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListAllGenres'),(select SecurityRoleId from SecurityRole where Code='standard'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='PickAlbums'),(select SecurityRoleId from SecurityRole where Code='standard'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='PickAlbumsGnre'),(select SecurityRoleId from SecurityRole where Code='standard'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ListPickedAlbums'),(select SecurityRoleId from SecurityRole where Code='standard'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='ChangePassword'),(select SecurityRoleId from SecurityRole where Code='standard'));


insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='Exit'),(select SecurityRoleId from SecurityRole where Code='admin'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='Exit'),(select SecurityRoleId from SecurityRole where Code='standard'));
insert into MenuSecurityRole (MenuId, SecurityRoleId) values ((select MenuId from Menu where MenuItemCode='Exit'),(select SecurityRoleId from SecurityRole where Code='manager'));
