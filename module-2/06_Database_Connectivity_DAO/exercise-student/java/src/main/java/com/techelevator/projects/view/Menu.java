...
import com.techelevator.projects.model.MenuItem;
...
public class Menu {
	...
	public Object getChoiceFromOptions(MenuItem[] options, String message) {
	...
	private Object getChoiceFromOptions(){
		Object choice = null;
		while (choice == null) {
			displayMenuOptions();
