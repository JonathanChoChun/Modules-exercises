...
public class Lecture {
    ...
    */
    public boolean returnCounterFromLoop() {
        ...
        int[] arrayToLoopThrough;
        arrayToLoopThrough = new int[4];
        arrayToLoopThrough[0] = 3;
        arrayToLoopThrough[1] = 4;
        arrayToLoopThrough[2] = 5;
        arrayToLoopThrough[3] = 9;
        //{ 3, 4, 2, 9 };

        arrayToLoopThrough[3] = 10;
    ...
    */
    public boolean returnCorrectCount() {
        //start at 0 and loop through cigars.length - 1;
        int[] cigars = new int[4];
        cigars[0] = 3;
        cigars[1] = 6;
        cigars[2] = 1;
        cigars[3] = 2;
        ...
        for (int i =0;i < cigars.length; i++) {
            totalCigars = totalCigars + cigars[i];
            //totalCigars += cigars[i];
        }
        //totalCigars will be 12
        return totalCigars>0;
    }
