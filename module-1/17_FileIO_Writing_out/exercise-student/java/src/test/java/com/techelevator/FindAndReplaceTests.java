...
public class FindAndReplaceTests {
    ...
    public void shouldReplaceNoWords() throws IOException {
        ...
        assertWithNormalizedCrLf(expected.trim(),destContent.trim());
    }
    ...
    private void assertWithNormalizedCrLf(String string1, String string2){
        assertEquals(string1.trim().replaceAll("\r\n","\n"),string2.trim().replaceAll("\r\n","\n"));
    }
}
